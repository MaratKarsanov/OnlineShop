# Online Shop
## О проекте
Online Shop — это интернет-магазин, разработанный на ASP.NET Core MVC. Основное приложение является монолитом, который взаимодействует с <a href="https://github.com/MaratKarsanov/Reviews">микросервисом отзывов</a>. В проекте используются различные технологии и инструменты для обеспечения функциональности, производительности и мониторинга.
